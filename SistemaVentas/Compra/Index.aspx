            ...
            <div class="modal-body-mio text-center">
                ...
                <div class="mt-4">
                    ...
                    <div class="d-inline">
                        ...
                        <input type="text" placeholder="Fecha de compra" class="form-control d-inline" id="inpFechaCompra" runat="server" />
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <div class="d-inline">
                        ...
                        <input type="text" placeholder="Hora de compra" class="form-control d-inline" id="inpHoraCompra" runat="server" />
                    </div>
                </div>
