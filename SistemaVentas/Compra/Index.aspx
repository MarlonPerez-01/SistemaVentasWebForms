<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SistemaCompras.Compra.Index" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <a href="~/PuntoDeCompra/Index.aspx" runat="server"><i class="fas fa-search-plus"></i><span>Crear Compra</span></a>

    <div class="w-100"></div>

    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="idCompra" OnRowCommand="GridView1_OnRowCommand" AllowPaging="True" PageSize="10" OnPageIndexChanging="GridView1_OnPageIndexChanging">
        <Columns>
    ...
    <asp:Panel ID="modalDetalles" runat="server" BackColor="White" Style="z-index: 111; background-color: White; position: fixed; top: 2vw; left: 50%; width: auto; height: auto; -webkit-transform: translate(-50%,2vw); -moz-transform: translate(-50%,2vw); -ms-transform: translate(-50%,2vw); -o-transform: translate(-50%,2vw); transform: translate(-50%,2vw); width: 50%; border-radius: 1em; padding: 1em; display: none">
        <div class="modal-contenedor">
            ...
            <div class="modal-body-mio">
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="idDetalleCompra" OnRowCommand="GridView1_OnRowCommand" AllowPaging="True" PageSize="10" OnPageIndexChanging="GridView1_OnPageIndexChanging">
                    <Columns>
    ...
    <asp:Panel ID="modalEditar" runat="server" BackColor="White" Style="z-index: 111; background-color: White; position: fixed; top: 2vw; left: 50%; width: auto; height: auto; -webkit-transform: translate(-50%,2vw); -moz-transform: translate(-50%,2vw); -ms-transform: translate(-50%,2vw); -o-transform: translate(-50%,2vw); transform: translate(-50%,2vw); width: 50%; border-radius: 1em; padding: 1em; display: none">
        <div class="modal-contenedor">
            ...
            <div class="modal-body-mio">
                <div>
                    <label for="inpIdCompra_e" class="col-form-label">ID:</label>
                    <input type="text" class="form-control" id="inpIdCompra_e" runat="server" />
                </div>
                <div>
                    <label for="inpPrimerNombreCompra_e" class="col-form-label">Proveedor:</label>
                    <asp:DropDownList ID="ddlProveedor_e" runat="server"></asp:DropDownList>
                </div>
                <div>
                    <label for="inpSegundoNombreCompra_e" class="col-form-label">Usuario:</label>
                    <asp:DropDownList ID="ddlUsuario_e" runat="server"></asp:DropDownList>
                </div>
                <div>
                    <label for="inpFechaCompra" class="col-form-label">Fecha de Compra:</label>
                    <input type="text" class="form-control" id="inpFechaCompra" runat="server" />
                </div>
                <div>
                    <label for="inpHoraCompra" class="col-form-label">Hora de Compra:</label>
                    <input type="text" class="form-control" id="inpHoraCompra" runat="server" />
                </div>
            </div>
            <div class="modal-footer-mio">
