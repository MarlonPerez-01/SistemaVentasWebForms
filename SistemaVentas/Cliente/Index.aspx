...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col">
        ...
        <div class="round-border mt-3">
            ...
            <asp:GridView ID="GridView1" CssClass="table table-sm  table-striped text-center" runat="server" AutoGenerateColumns="False" DataKeyNames="idCliente" OnRowCommand="GridView1_OnRowCommand" AllowPaging="True" PageSize="10" OnPageIndexChanging="GridView1_OnPageIndexChanging">
                <Columns>
    ...
    <asp:Panel ID="modalCrear" runat="server" BackColor="White" Style="z-index: 111; background-color: White; position: fixed; top: 2vw; left: 50%; width: auto; height: auto; -webkit-transform: translate(-50%,2vw); -moz-transform: translate(-50%,2vw); -ms-transform: translate(-50%,2vw); -o-transform: translate(-50%,2vw); transform: translate(-50%,2vw); width: 50%; border-radius: 1em; padding: 1em; display: none">
        <div class="modal-contenedor">
            ...
            <div class="modal-body-mio text-center">
                ...
                <div class="mt-4">
                    <div class="d-inline">
                        <label for="inpDuiCliente_c" class="col-form-label"><i class="far fa-address-card d-inline mr-2"></i></label>
                        <input type="text" placeholder="DUI" class="form-control d-inline" id="inpDuiCliente_c" runat="server" />
                    </div>
                    <div class="d-inline">
                        <label for="inpNitCliente_c" class="col-form-label"><i class="far fa-address-card d-inline mx-2"></i></label>
                        <input type="text" placeholder="NIT" class="form-control d-inline" id="inpNitCliente_c" runat="server" />
                    </div>
                </div>

                <div class="mt-4">
                    <label for="inpTelefonoCliente_c" class="col-form-label"><i class="fas fa-mobile-alt d-inline mx-2"></i></label>
            ...
            <div class="modal-footer-mio mt-3 text-center">
            ...
            <div class="modal-body-mio text-center">
                ...
                <div class="mt-4">
                    ...
                    <div class="d-inline">
                        ...
                        <input type="text" placeholder="Primer nombre" class="form-control d-inline" id="inpPrimerNombreCliente_e" runat="server" />
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <div class="d-inline">
                        ...
                        <input type="text" placeholder="Segundo nombre" class="form-control d-inline" id="inpSegundoNombreCliente_e" runat="server" />
                    </div>
                    <div class="d-inline">
                        <label for="inpPrimerApellidoCliente_e" class="col-form-label"><i class="far fa-user d-inline mx-2"></i></label>
                        <input type="text" placeholder="Primer apellido" class="form-control d-inline" id="inpPrimerApellidoCliente_e" runat="server" />
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <div class="d-inline">
                        ...
                        <input type="text" placeholder="Segundo apellido" class="form-control d-inline" id="inpSegundoApellidoCliente_e" runat="server" />
                    </div>
                    <div class="d-inline">
                        <label for="inpDuiCliente_e" class="col-form-label"><i class="far fa-address-card d-inline mx-2"></i></label>
                        <input type="text" placeholder="DUI" class="form-control d-inline" id="inpDuiCliente_e" runat="server" />
                    </div>
                </div>

                <div class="mt-4">
                    <div class="d-inline">
                        <label for="inpNitCliente_e" class="col-form-label"><i class="far fa-address-card d-inline mr-2"></i></label>
                        <input type="text" placeholder="NIT" class="form-control d-inline" id="inpNitCliente_e" runat="server" />
                    </div>
                    <div class="d-inline">
                        <label for="inpTelefonoCliente_e" class="col-form-label"><i class="fas fa-mobile-alt d-inline mx-2"></i></label>
                        <input type="text" placeholder="Telefono" class="form-control d-inline" id="inpTelefonoCliente_e" runat="server" />
                    </div>
                </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkInputs(lista, e) {
            ...
            if (pNombre.val().trim() === '') {
                setErrorFor(pNombre, "Primer nombre");
            }
            else {
            ...
            if (sNombre.val().trim() === '') {
                setErrorFor(sNombre, "Segundo Nombre");
            }
            else {
            ...
            if (pApell.val().trim() === '') {
                setErrorFor(pApell, "Primer apellido");
            }
            else {
            ...
            if (sApell.val().trim() === '') {
                setErrorFor(sApell, "Segundo apellido");
            }
            else {
